from biui.Enum import Keys, KeyModifiers
...
class ShortcutControl(object):
    ...
    ##
    ##
    def isCopy(self,event):
        return event.modifiers & KeyModifiers.CTRL and event.keyCode == Keys.K_c
    
    ###
    ##
    ##
    def isPaste(self,event):
        return event.modifiers & KeyModifiers.CTRL and event.keyCode == Keys.K_v
    
    ###
    ##
    ##
    def isMoveSelectionRight(self,event):
        return event.modifiers & KeyModifiers.ALT and event.keyCode == Keys.K_RIGHT
    
    ###
    ##
    ##
    def isMoveSelectionUp(self,event):
        return event.modifiers & KeyModifiers.ALT and event.keyCode == Keys.K_UP
    
    ###
    ##
    ##
    def isMoveSelectionLeft(self,event):
        return event.modifiers & KeyModifiers.ALT and event.keyCode == Keys.K_LEFT
    
    ###
    ##
    ##
    def isMoveSelectionDown(self,event):
        return event.modifiers & KeyModifiers.ALT and event.keyCode == Keys.K_DOWN
