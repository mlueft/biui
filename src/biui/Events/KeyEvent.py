...
class KeyEvent(DOMEvent):
    ...
    def __decodeKeyCode(self):
        ...
        elif self.__keyCode == Keys.K_KP_0: result += "K_KP0";
        elif self.__keyCode == Keys.K_KP_1: result += "K_KP1";
        elif self.__keyCode == Keys.K_KP_2: result += "K_KP2";
        elif self.__keyCode == Keys.K_KP_3: result += "K_KP3";
        elif self.__keyCode == Keys.K_KP_4: result += "K_KP4";
        elif self.__keyCode == Keys.K_KP_5: result += "K_KP5";
        elif self.__keyCode == Keys.K_KP_6: result += "K_KP6";
        elif self.__keyCode == Keys.K_KP_7: result += "K_KP7";
        elif self.__keyCode == Keys.K_KP_8: result += "K_KP8";
        elif self.__keyCode == Keys.K_KP_9: result += "K_KP9";
